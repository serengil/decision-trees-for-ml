...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Decision Trees for Machine Learning")
    parser.add_argument('--algorithm', type=str, default="C4.5", choices=["ID3", "C4.5", "CART", "Regression"], help='Algorithm to use')
    parser.add_argument('--dataset', type=str, default="dataset/golf.txt", help='Path to dataset file')
    parser.add_argument('--random-forest', action='store_true', help='Enable Random Forest')
    parser.add_argument('--num-trees', type=int, default=3, help='Number of trees for Random Forest')
    parser.add_argument('--multitasking', action='store_true', help='Enable multitasking for Random Forest')
    parser.add_argument('--adaboost', action='store_true', help='Enable Adaboost')
    parser.add_argument('--gradient-boosting', action='store_true', help='Enable Gradient Boosting')
    parser.add_argument('--epochs', type=int, default=10, help='Number of epochs for boosting')
    parser.add_argument('--learning-rate', type=float, default=1, help='Learning rate for boosting')
    parser.add_argument('--dump-to-console', action='store_true', help='Print rules to console instead of file')
    args = parser.parse_args()

    algorithm = args.algorithm
    enableRandomForest = args.random_forest
    num_of_trees = args.num_trees
    enableMultitasking = args.multitasking
    dump_to_console = args.dump_to_console
    enableGradientBoosting = args.gradient_boosting
    epochs = args.epochs
    learning_rate = args.learning_rate
    enableAdaboost = args.adaboost
